...
class LockNote
  ...
  def self.def_action(name, options, way = nil)
    define_method name do
      ...
      way ||= @@default_way #<callout id="co.default_way"/>
      key = case way
        when nil;     keys.last
...
class SimpleFormatter < Logger::Formatter #<callout id="co.simple_formatter"/>
...
$logger.formatter = SimpleFormatter.new #<callout id="co.change_formatter"/>
# END:logger
